        ...
        <div class="hidden lg:flex lg:flex-1 justify-center lg:gap-x-12" id="openMenuItems">
          ...
          <div id="dropdownHover" class="z-10 hidden bg-white bg-opacity-50 divide-y divide-gray-100 rounded-lg shadow">
            <ul class="flex list-none py-2 sm:py-4 md:py-3 lg:py-2 xl:py-1 text-sm text-gray-900" aria-labelledby="dropdownHoverButton">
              <li>
                <a href="./Build/php/bookingPage.php" class="block px-2 py-1 hover:underline">Flight</a>
              </li>
              <li>
                <a href="./Build/php/hotelBookingPage.php" class="block px-2 py-1 hover:underline">Hotel</a>
              </li>
            </ul>
          </div>
